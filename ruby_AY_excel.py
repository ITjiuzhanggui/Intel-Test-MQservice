...
def read_status_log(writer, status_json_filename):
...
if __name__ == '__main__':
    loop_count = 0
    status_json_filename = r"C:\Users\xinhuizx\python_Code\MQ_script\2019-06-20\json\status\1560968023.json"
    writer = pd.ExcelWriter(r"C:\Users\xinhuizx\python_Code\MQ_script\MQ_tset.xlsx")
    read_status_log(writer, status_json_filename)

    for root_dir, _, files in os.walk(r"C:\Users\xinhuizx\python_Code\MQ_script\2019-06-20\json\test"):
        print(files)
        for json_filename in files:
            full_file_name = os.path.join(root_dir, json_filename)
            print("正在解析%s文件" % full_file_name)
